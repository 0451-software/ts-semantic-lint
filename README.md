...
The source is plain TypeScript; no transpiler beyond `tsc`. Node 22.19 or newer is required (matches the runtime requirement imposed by `commander@^15.0.0` + `eslint@^10.11.0` + `undici@^8.11.0`).
